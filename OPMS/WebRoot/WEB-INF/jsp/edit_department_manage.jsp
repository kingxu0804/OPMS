...
<section>
    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right"><a href="add_department_manage.html" class="btn btn-success">+添加新部门</a></div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" id="depart-form" novalidate="novalidate" action="editDepart">
                                <input type="hidden" name="departid" value="${pmsdepart.departid }">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>名称</label>
                                    <div class="col-sm-10">
                                        <input id="checkname" name="name" oldname="${pmsdepart.name }" value="${pmsdepart.name }" class="form-control" placeholder="请填写名称" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">描述</label>
                                    <div class="col-sm-10">
                                        <textarea name="description" placeholder="请填写描述" style="height: 90px;" class="form-control">${pmsdepart.description }</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
