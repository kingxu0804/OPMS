                            ...
                            <div class="panel">
                                ...
                                <c:forEach items="${list }" var="pmsProjectsVersion">
	                                <div class="profile-desk">
	                                        <h1>版本描述</h1>
	                                        <div class="content">${pmsProjectsVersion.content }</div>
	                                        <h1>源代码地址</h1>
	                                        <div class="content">
	                                        	<a href="${pmsProjectsVersion.sourceurl }" target="_blank">查看链接</a> 
	                                        </div>
	                                        <h1>下载地址</h1>
	                                        <div class="content">
	                                        	<a href="${pmsProjectsVersion.downurl }" target="_blank">查看链接</a> 
	                                        </div>
	                                        <a class="btn p-follow-btn" href="getPmsProjectsVersionToModify${pmsProjectsVersion.versionid }"> 
	                                        <i class="fa fa-check"></i> 编辑</a>&nbsp; 
	                                        <a href="javascript:;" class="btn p-follow-btn js-version-delete" data-id="${pmsProjectsVersion.versionid }"> 
	                        ...
	                        <div class="panel-body">
	                            <ul class="p-info">
	                                <li>
	                                    ...
	                                    <div class="desk">${pmsProjectsVersion.title }</div>
	                                </li>
	                                <li>
	                                ...
	                                <li>
	                                    ...
	                                    <div class="desk">${pmsProjectsVersion.username }</div>
	                                </li>
	                            </ul>
	                        </div>
	                    </div>
