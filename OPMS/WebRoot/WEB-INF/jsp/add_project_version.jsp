                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form onsubmit="sub();" id="version-form01" action="insertPmsProjectsVersion" method="post" enctype="multipart/form-data" class="form-horizontal adminex-form" novalidate="novalidate">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>版本名称</label>
                                    <div class="col-sm-10">
                                        <input id="title" name="title" class="form-control" placeholder="请输入版本名称" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>打包日期</label>
                                    <div class="col-sm-10">
                                        <input class="form-control dpd1 hasDatepicker" id="versioned" name="versioned" placeholder="打包日期" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">源代码地址</label>
                                    <div class="col-sm-10">
                                        <input name="sourceurl" class="form-control" placeholder="http://" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">下载地址</label>
                                    <div class="col-sm-10">
                                        <input name="downurl" class="form-control" placeholder="http://" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
