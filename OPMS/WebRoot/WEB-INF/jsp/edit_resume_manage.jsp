...
<head>
    ...
    <link href="<%=request.getContextPath()%>/css/default.css" rel="stylesheet"></head><body class="sticky-header">
<section>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form onsubmit="return sub();" action="updateResumes" method="post" enctype="multipart/form-data" class="form-horizontal adminex-form" id="resume-form02" novalidate="novalidate">
                                <input name="resumeid" value="${pmsResumes.resumeid }" type="hidden">
                                <input name="created" value="${pmsResumes.created }" type="hidden">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>姓名</label>
                                    <div class="col-sm-10">
                                        <input onblur="checkRealname(this);" id="realname" name="realname" value="${pmsResumes.realname }" class="form-control" placeholder="请输入姓名" type="text">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input onblur="checkPhone(this);" id="phone" name="phone" value="${pmsResumes.phone }" class="form-control" placeholder="请输入手机号" type="text">
                                    	<span style="color:red"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input onblur="checkBirth(this);" onchange="checkBirth(this);" readonly="readonly" id="birth" name="birth" id="default-date-picker" value="${pmsResumes.birth }" class="form-control hasDatepicker" placeholder="出生日期" type="text">
                                    	<span style="color:red"></span>
                                    </div>
                                </div>
                                <div class="form-group">
...
<!--                                         		<option value="0">请选择学历</option> -->
                                        		<c:set value="<%=com.opms.entity.PmsResumesEducation.values() %>" var="list"></c:set>
	                                           	<c:forEach items="${list }" var="pmsResumesEducation">
		                                           	<c:if test="${pmsResumes.edu==pmsResumesEducation.pmsResumesEducationindex }">
	                                           			<option value="${pmsResumesEducation.pmsResumesEducationindex}" selected="selected">${pmsResumesEducation.pmsResumesEducationname }</option>
	                                           		</c:if>
		                                           	<c:if test="${pmsResumes.edu!=pmsResumesEducation.pmsResumesEducationindex }">
...
<!--                                             <option value="0">请选择工作年限</option> -->
                                           	...
                                           	<c:forEach items="${list }" var="pmsResumesWork">
                                           		<c:if test="${pmsResumes.work==pmsResumesWork.pmsResumesWorkindex }">
                                           			<option value="${pmsResumesWork.pmsResumesWorkindex}" selected="selected">${pmsResumesWork.pmsResumesWorkname }</option>
                                           		</c:if>
                                           		<c:if test="${pmsResumes.work!=pmsResumesWork.pmsResumesWorkindex }">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="note" placeholder="备注说明" style="height: 300px; " class="form-control">${pmsResumes.note }</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <br>
                                        <a href="${pmsResumes.attachment}" target="_blank">预览下载</a>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
	                                 	...
	                                 	<c:forEach items="${list }" var="pmsResumesState">
	                                 		<c:if test="${pmsResumes.status==pmsResumesState.pmsResumesStateindex }">
                                           		<label class="radio-inline">
                                           		<input name="status" checked="checked" value="${pmsResumesState.pmsResumesStateindex}" type="radio">
	                                            ${pmsResumesState.pmsResumesStatename } </label>
                                           	</c:if>
                                      		<c:if test="${pmsResumes.status!=pmsResumesState.pmsResumesStateindex }">
                                      			<label class="radio-inline">
                                      			<input name="status" value="${pmsResumesState.pmsResumesStateindex}" type="radio">
	                                            ${pmsResumesState.pmsResumesStatename } </label>
                                      		</c:if>
	                                 	</c:forEach>
                                    </div>
