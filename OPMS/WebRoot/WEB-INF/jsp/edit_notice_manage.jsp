...
<section>
    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right"><a href="add_notice_manage.html" class="btn btn-success">+添加新公告</a></div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form action="editNotice" class="form-horizontal adminex-form" id="notice-form" novalidate="novalidate">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>标题</label>
                                    <input type="hidden" name="noticeid" value="${notice.noticeid }">
                                    <div class="col-sm-10">
                                        <input id="noticetitle" name="title" oldtitle="${notice.title }" value="${notice.title }" class="form-control" placeholder="请填写名称" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
