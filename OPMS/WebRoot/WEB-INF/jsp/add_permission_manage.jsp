                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" id="permission-form" novalidate="novalidate" action="addPermission" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="name" value="" class="form-control" placeholder="请输入名称，如项目管理" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>英文名称</label>
                                    <div class="col-sm-10">
                                        <input name="ename" value=""
                                         id="form-control3" data-positionid="0"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="icon" value="" class="form-control" placeholder="主栏目ICON：user、tasks、suitcase、plane、laptop、home、book" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">排序</label>
                                    <div class="col-sm-10">
                                        <input name="weight" value="0" class="form-control" placeholder="数字" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 col-sm-2 control-label"></label>
                                    <div class="col-lg-10">
                                        <input name="id" id="permissionid" value="0" type="hidden">
