    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right">
                ...
                <a href="approvalexpense" class="hidden-xs btn btn-default" style="padding: 4px;">待审批</a>
                <a href="addexpensemanage" class="btn btn-success">+我要报销</a> </div>
        </div>
                        ...
                        <div class="single-blog">
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <p class="text-center auth-row"> By <a href="http://opms.demo.milu365.cn/user/show/1461312703628858832">${user.username }</a> | <fmt:formatDate value="${expenseDetail.created }" pattern="yyyy-MM-dd HH:mm"/></p>
                                    <div id="print">
                                        <table class="table table-bordered" border="1">
                                            ...
                                            <tr>
                                                <td>日期</td>
                                                <td colspan="5"><fmt:formatDate value="${expenseDetail.created }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                            </tr>
                                            <tr >
                                                <td>总金额</td>
                                                <td colspan="5">${expenseDetail.total }元</td>
                                            </tr>
                                            <tr id="expense-box">
                                                <td>类型</td>
                                    ...
                                    <input type="hidden" value="${expenseDetail.amounts }" id="amounts">
                                    <input type="hidden" value="${expenseDetail.types }" id="types">
                                    <input type="hidden" value="${expenseDetail.contents }" id="contents">
                                    <a class="btn btn-xs btn-warning" style="margin-bottom: 6px;">审批人进度</a>
                                    <div class="js-selectuserbox"> <a href="javascript:;" title="lock"><img class="gray" src="img/1.jpg" alt="lock">未处</a> </div>
                                </div>
                            </div>
                            <div class="panel">
                                <div class="panel-body">
