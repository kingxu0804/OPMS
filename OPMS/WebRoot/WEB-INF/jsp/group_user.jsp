...
<section>
    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right"><a href="toAddGroupUser?groupid=${group.groupid }" class="btn btn-success">+新成员</a></div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading"> 组成员 / 总数：${count}<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a>
              </span> </header>
                            ...
                            <section id="unseen">
                                <form id="project-form-list">
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody>
                                        <c:forEach items="${listgroupsusers}" var="groupsuser">
                                        	<tr>
                                        		<td>${groupsuser.realname }</td>
                                        		<td>${groupsuser.name }</td>
                                        		<td><a href="#" class="js-group-user-single" id="${groupsuser.id }">删除</a></td>
                                        	</tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
