...
<section>
    ...
    <div class="main-content">
        <div class="header-section">
            ...
            <form class="searchform" action="searchDeparts" method="post">
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb pull-left">
                <li> <a href="#">OPMS</a> </li>
                <li> <a href="getDeparts">部门管理</a> </li>
                <li class="active"> 部门 </li>
            </ul>
            <div class="pull-right"><a href="toAddDepartment" class="btn btn-success">+添加新部门</a></div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading"> 部门管理 / 总数：${counter }<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a>
                            ...
                            <section id="unseen">
                                <form id="department-form-list">
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody>
                                        <c:forEach items="${listPmsDeparts }" var="depart">
                                        <tr>
                                            <td>${depart.name}</td>
                                            <td>${depart.description }</td>
                                            <td>
                                            <c:if test="${depart.status==1}">正常 </c:if>
                                            <c:if test="${depart.status==2}">屏蔽 </c:if>
                                            </td>
                                            <td><div class="btn-group">
                                                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 操作<span class="caret"></span> </button>
                                                <ul class="dropdown-menu">
                                                    <li><a href="getDepartById?departid=${depart.departid}">编辑</a></li>
                                                    <li role="separator" class="divider"></li>
                                                    <li><a href="#"  class="js-depart-single" departid="${depart.departid}" status="${depart.status==1?2:1}">  
                                                    	<c:if test="${depart.status==1}"><div >屏蔽</div>
                                                    	 </c:if>
                                                    	<c:if test="${depart.status==2}">正常</c:if>
                                                    </a></li>
                                                </ul>
                                            </div></td>
                                        </tr>
