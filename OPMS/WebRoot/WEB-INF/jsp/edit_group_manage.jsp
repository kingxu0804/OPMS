                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" id="group-form" action="editGroup" novalidate="novalidate">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>组名称</label>
                                    <div class="col-sm-10">
                                        <input id="groupname" name="name" value="${group.name }" oldname="${group.name }" class="form-control" placeholder="请输入组名称" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
