...
<section>
    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right"><a href="dispatchPage" class="btn btn-success">添加新项目</a></div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form action="<%=request.getContextPath() %>/updatePmsProjects" method="post" class="form-horizontal adminex-form" id="project-form" novalidate="novalidate">
                                <input type="hidden" name="projectid" value="${project.projectid}"/>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>项目名称</label>
                                    <div class="col-sm-10">
                                        <input name="name" id="projectname" value="${project.name}" class="form-control" placeholder="请填写名称" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>项目别名</label>
                                    <div class="col-sm-10">
                                        <input name="aliasname" value="${project.aliasname}" class="form-control" placeholder="取个代号" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-large custom-date-range" data-date="2016-07-07" data-date-format="yyyy-mm-dd">
                                            <input id="datetimeStart" class="form-control dpd1" name="startdate" placeholder="开始日期" value="${project.getStringStartDate()}" type="text">
                                            <span class="input-group-addon">To</span>
                                            <input id="datetimeEnd" class="form-control dpd2" name="enddate" placeholder="结束日期" value="${project.getStringEndDate()}" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="projectdescribe" placeholder="请填写描述" style="height: 300px;" class="form-control">${project.getProjectdescribe()}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="projuserid" class="form-control">
                                            <option style="display:none;" checked value="${project.projectid}">${project.projectResponsePeople}</option>
                                            <c:forEach  items="${teamMesg}" var="team">
                                               <c:if test="${team.userid!=null}">
                                                  <option value="${team.userid}">11${team.username}</option>
                                               </c:if>
                                            </c:forEach>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="id" value="104582058893905920" type="hidden">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="" class="btn btn-primary">去设置管理</a>
            </div>
        </div>
    </div>
</div>
