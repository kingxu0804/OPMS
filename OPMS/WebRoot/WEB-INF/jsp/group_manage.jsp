...
<section>
    ...
    <div class="main-content">
        <div class="header-section">
            ...
            <form class="searchform" action="searchGroups" method="post">
                <input class="form-control" name="name" placeholder="请输入组名称" value="" type="text">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right"> <a href="toAddGroup" class="btn btn-success">+新增组</a> </div>
        </div>
        ...
        <div class="wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading"> 组管理 / 总数：${count }<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a> </span> </header>
                        <div class="panel-body">
                            <table class="table table-bordered table-striped table-condensed">
                                ...
                                <c:forEach items="${listgroups }" var="group">
                                	<tr>
                                		<td>${group.name }</td>
                                		<td class="hidden-phone hidden-xs">${group.summary }</td>
                                		<td><div class="btn-group">
                                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 操作<span class="caret"></span> </button>
                                        <ul class="dropdown-menu">
                                            <li><a href="toGroupPermission?groupid=${ group.groupid}">权限</a></li>
                                            <li role="separator" class="divider"></li>
                                            <li><a href="getGroupUsers?groupid=${ group.groupid}">成员</a></li>
                                            <li role="separator" class="divider"></li>
                                            <li><a href="toEditGroup?groupid=${ group.groupid}">编辑</a></li>
                                            <li role="separator" class="divider"></li>
                                            <li><a href="#" class="js-group-delete" groupid="${group.groupid }">删除</a></li>
                                        </ul>
                                    </div></td>
                                	</tr>
                                </c:forEach>
