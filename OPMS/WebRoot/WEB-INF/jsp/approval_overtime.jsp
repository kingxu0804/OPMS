    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            <h3> 审批管理
                <span>
                    ...
                    <a href="businesstrip_manage.html">出差</a>
                    <a href="goout_manage.html">外出</a>
                    <a href="oagood_manage.html">物品</a>
                </span>
            </h3>
            ...
            <div class="pull-right">
                <a href="overtime_manage.html" class="btn btn-success" style="padding: 4px;">加班</a>
                <a href="approvalovertime" class="btn btn-default active" style="padding: 4px;">待审批</a>
        ...
        <div class="wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading"> 加班 / 总数：${listApproverOvertime.size() }<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a> </span> </header>
                        <div class="panel-body">
                            <table class="table table-hover general-table">
                                ...
                                <tbody>
                          <c:if test="${listApproverOvertime.size()==0 }">
                                <tr>
                                    <td colspan="7">数据暂时为空</td>
                                </tr>
                            </c:if><c:if test="${listApproverOvertime.size()>0 }">
                            <c:forEach items="${listApproverOvertime }" var="aotime">
...
<script src="js/jsopms.js"></script>
</body>
</html>