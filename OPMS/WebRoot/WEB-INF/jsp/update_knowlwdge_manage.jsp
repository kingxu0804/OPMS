                              ...
                              <input type="hidden" name="knowid" value="${pmsKnowledges.knowid}">
                               <input type="hidden" name="userid" value="${user.userid}">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="sortid" class="form-control" id="selectsortid">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="title" value="${pmsKnowledges.title}" class="form-control" placeholder="请填写标题" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">标签</label>
                                    <div class="col-sm-10">
                                        <input name="tag" value="${pmsKnowledges.tag}" class="form-control" placeholder="填写标签" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">URL</label>
                                    <div class="col-sm-10">
                                        <input name="url" value="${pmsKnowledges.url}" class="form-control" placeholder="http://" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>简介</label>
                                    <div class="col-sm-10">
                                        <textarea name="summary" placeholder="请填写简介" style="height: 90px;" class="form-control">${pmsKnowledges.summary}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>内容</label>
                                    <div class="col-sm-10">
                                        <textarea name="content" placeholder="请填写内容" style="height: 400px;" class="form-control">${pmsKnowledges.content}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script>
    $(function(){
    	...
    	$("#selectsortid").val(${pmsKnowledges.sortid});
