...
<section>
    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right"><a href="#" class="btn btn-success">+添加新职称</a></div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" action="addPosition" method="post" id="position-form" novalidate="novalidate">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>名称</label>
                                    <div class="col-sm-10">
                                        <input name="name" id="form-control2"    data-position="0"   value="" class="form-control" placeholder="请填写名称" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">描述</label>
                                    <div class="col-sm-10">
                                        <textarea name="description" placeholder="请填写描述" style="height: 90px;" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
