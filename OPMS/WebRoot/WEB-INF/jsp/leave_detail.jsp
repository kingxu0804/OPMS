    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right">
                ...
                <a href="approvalleave" class="hidden-xs btn btn-default" style="padding: 4px;">待审批</a>
                <a href="goaddleavemanage" class="btn btn-success">+我要请假</a> </div>
        </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="print">
                                        <table class="table table-bordered" border="1">
                                            ...
                                            <tr>
                                                <td>事由</td>
                                                <td colspan="5">${leavedetail.reason }</td>
                                            </tr>
                                            <tr>
                                                <td>日期</td>
                                                <td colspan="5"> 
                                                <fmt:formatDate
 												value="${leavedetail.started }" type="Date" 
 												pattern="yyyy-MM-dd " /> 至<fmt:formatDate 
												value="${leavedetail.ended }" type="Date" 
												pattern="yyyy-MM-dd" /> 
												</td>
                                            </tr>
                                            <tr>
                                                <td>天数</td>
                                                <td colspan="5"><fmt:formatNumber value="${leavedetail.days }" pattern="0"/> 天</td>
                                            </tr>
                                            <tr class="hide">
                                                <td>审核人</td>
                                                <td colspan="5">&nbsp;</td>
