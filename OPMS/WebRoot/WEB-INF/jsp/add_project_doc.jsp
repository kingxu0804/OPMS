                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form onsubmit="sub();" action="insertPmsProjectsDoc" method="post" enctype="multipart/form-data"  class="form-horizontal adminex-form" id="doc-form01" novalidate="novalidate">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>文档名称</label>
                                    <div class="col-sm-10">
                                        <input id="title" name="title" value="" class="form-control" placeholder="请输入文档名称" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">关键字</label>
                                    <div class="col-sm-10">
                                        <input name="keyword" value="" class="form-control" placeholder="请输入关键字" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="url" value="" class="form-control" placeholder="http://" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
