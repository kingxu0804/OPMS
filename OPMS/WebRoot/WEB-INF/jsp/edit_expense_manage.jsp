                            ...
                            <form class="form-horizontal adminex-form" id="expense-form" novalidate="novalidate" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       ...
                                       <div id="imageshow"> <img id="imagebefor" src="${editExpense.picture }" style=width:120px;height:70px ><img id="imgshow" src=""></div> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="approverids" id="approverid" value="${editExpense.approverids}" type="hidden">
                                        <input name="total" id="total" value="${editExpense.total }" type="hidden">
                                        <input name="expenseid" id="expenseid" value="${editExpense.expenseid }" type="hidden">
                                        <input name="id" id="expenseid" value="${user.userid }" type="hidden">
                                        <button  id="submitbutton" class="btn btn-primary">提交保存</button>
                                    </div>
                                    <input type="hidden" value="${editExpense.amounts }" id="amounts">
                                    <input type="hidden" value="${editExpense.types }" id="types">
                                    <input type="hidden" value="${editExpense.contents }" id="contents">
                                </div>
                            </form>
                        </div>
                    </section>
        ...
        $('#expense-form').validate({
            ...
            submitHandler : function(){
				...
				var jsondata={'amounts':amounts,'types':types,'contents':contents,'picture':picture,'approverids':approverids,'expenseid':expenseid};
            			...
            			$("#submitbutton").submit(
        				$.ajax({
        					url:'updateExpenseInfo',
        					type:'post',
        					dataType:'json',
        					data:{jsondata:JSON.stringify(jsondata)},
        				 success:function(data){
        					 alert(data);
                          window.location.href="expensemanage" ;
                             }
        		 		   })
        				);
        		  return false;
