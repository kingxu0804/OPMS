                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="insertgooutmanage" method="post" class="form-horizontal adminex-form" id="goout-form" novalidate="novalidate">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-large custom-date-range" data-date="2016-07-07" data-date-format="yyyy-mm-dd hh:ii">
                                            <input id="datetimeStart" class="form-control dpd1" name="started" placeholder="开始时间" value="" type="text">
                                            <span class="input-group-addon">To</span>
                                            <input id="datetimeEnd" class="form-control dpd2" name="ended" placeholder="结束时间" value="" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="hours"  class="form-control" placeholder="请输入数字" type="number">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>外出事由</label>
                                    <div class="col-sm-10">
                                        <textarea name="reason" placeholder="外出事由" style="height: 200px;" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="approverids" id="approverid" value="" type="hidden">
                                        <input name="userid" id="gooutid" value="${user.userid }" type="hidden">
