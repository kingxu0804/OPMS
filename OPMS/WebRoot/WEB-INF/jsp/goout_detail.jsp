    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb pull-left">
                ...
                <li> <a href="approval_index.html">审批管理</a> </li>
                <li class="active"> 加班单详情 </li>
            </ul>
            <div class="pull-right">
                <a href="javascript:history.back();" class="btn btn-default">返回</a>
                <a href="approval_overtime.html" class="hidden-xs btn btn-default" style="padding: 4px;">待审批</a>
                <a href="add_goout_manage.html" class="btn btn-success">+我要外出</a> </div>
        </div>
                        ...
                        <div class="single-blog">
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <p class="text-center auth-row"> By <a href="">李白</a> | 2017-07-09 20:30</p>
                                    <div id="print">
                                        <table class="table table-bordered" border="1">
                                            ...
                                            <tr>
                                                <td>外出事由</td>
                                                <td colspan="5">不错支持下你重新</td>
                                            </tr>
                                            <tr>
                                                <td>外出时间</td>
                                                <td colspan="5">2017-07-04 09:30至2017-06-27 20:45</td>
                                            </tr>
                                            <tr>
                                                <td>时长</td>
                                                <td colspan="5">4小时</td>
