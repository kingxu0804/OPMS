    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb pull-left">
                <li> <a href="#">OPMS</a> </li>
                <li> <a href="getGroupUsers?groupid=${group.groupid }">${group.name}</a> </li>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" id="group-user-form" novalidate="novalidate" action="addGroupsUser">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">姓名</label>
                                    <div class="col-sm-10">
                                    	<input name="userid" id="team-userid" value="" type="hidden">
                                        <input name="username" id="team-username" value="" class="form-control js-search-username" placeholder="请输入姓名或用户名匹配" type="text">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="groupid" id="groupid" value="${group.groupid }" type="hidden">
