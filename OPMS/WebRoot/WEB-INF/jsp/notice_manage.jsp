...
<section>
    ...
    <div class="main-content">
        <div class="header-section">
            ...
            <form class="searchform" action="searchNotices" method="post">
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb pull-left">
                <li> <a href="#">OPMS</a> </li>
                <li> <a href="getNotices">公告管理</a> </li>
                <li class="active"> 公告 </li>
            </ul>
            <div class="pull-right"><a href="toAddNotice" class="btn btn-success">+添加新公告</a></div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading"> 公告管理 / 总数：${counter }<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a>
                            ...
                            <section id="unseen">
                                <form id="notice-form-list">
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody>
										<c:forEach items="${listnotices }" var="notice">
											<td>${notice.title }</td>
                                            <td>${notice.content}</td>
                                            <td>
                                            <c:if test="${notice.status==1 }">正常
                                            </c:if>
                                            <c:if test="${notice.status==2 }">屏蔽
                                            </c:if>
                                            </td>
                                            <td><div class="btn-group">
                                                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 操作<span class="caret"></span> </button>
                                                <ul class="dropdown-menu">
                                                    <li><a href="toEditNotice?noticeid=${notice.noticeid }">编辑</a></li>
                                                    <li role="separator" class="divider"></li>

                                                    <li><a href="#" class="js-notice-single" noticeid="${notice.noticeid }" status="${notice.status==1?2:1 }">
                                                    <c:if test="${notice.status==1 }">屏蔽</c:if>
                                                    <c:if test="${notice.status==2 }">正常</c:if>
                                                    </a></li>

                                                    <li role="separator" class="divider"></li>
                                                    <li><a href="#" class="js-notice-delete"  data-op="delete" noticeid="${notice.noticeid }">删除</a></li>
                                                </ul>
                                            </div></td>
                                        </tr>
										</c:forEach>
