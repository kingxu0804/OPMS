    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right">
                <a href="businesstrip_manage.html" class="btn btn-success" style="padding: 4px;">出差</a>
                <a href="" class="btn btn-default active" style="padding: 4px;">待审批</a>
                <a href="" class="hidden-xs  btn btn-default " style="padding: 4px;">已审核</a> </div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading"> 出差 / 总数：${approvalbusinesstrip.size()}<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a> </span> </header>
                        <div class="panel-body">
                            <table class="table table-hover general-table">
                                ...
                                <tbody>
                         <c:if test="${approvalbusinesstrip.size()==0 }">
                                <tr>
                                    <td colspan="7">数据暂时为空</td>
                                </tr>
                           </c:if><c:if test="${approvalbusinesstrip.size()>0 }">
                           <c:forEach items="${approvalbusinesstrip}" var="ABusinesstrip">
                             <tr>
                                    <td class="hidden-phone hidden-xs">${ABusinesstrip.userid }</td>
                                    <td><fmt:formatDate value="${ABusinesstrip.created }" pattern="yyyy-MM-dd"/> </td>
                                    <td><span>${ABusinesstrip.days }天</span></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button onclick="javaScript:window.location.href='businesstripapproval?businesstripid=${ABusinesstrip.businesstripid}'" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 审批</button>
                                            </div>
                                    </td>
                                </tr>
                           </c:forEach>
