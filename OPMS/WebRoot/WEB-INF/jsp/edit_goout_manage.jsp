                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="updategooutinfo" method="post" class="form-horizontal adminex-form" id="goout-form" novalidate="novalidate">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-large custom-date-range" data-date="2016-07-07" data-date-format="yyyy-mm-dd hh:ii">
                                            <input id="datetimeStart"  class="form-control dpd1" name="started" placeholder="开始时间" value="${editgoout.started }" type="text">
                                            <span class="input-group-addon">To</span>
                                            <input id="datetimeEnd" class="form-control dpd2" name="ended" placeholder="结束时间" value="${editgoout.ended }" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="hours"  value='<fmt:formatNumber value="${editgoout.hours }" pattern="0"></fmt:formatNumber>' class="form-control" placeholder="请输入数字" type="number">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>外出事由</label>
                                    <div class="col-sm-10">
                                        <textarea name="reason" placeholder="外出事由" style="height: 200px;" class="form-control">${editgoout.reason }</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       ...
                                       <div id="imageshow"> <img id="imagebefor" src="${editgoout.picture }" style=width:120px;height:70px ><img id="imgshow" src=""></div> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="approverid" id="approverid" value="${editgoout.approverids }" type="hidden">
                                        <input name="gooutid" id="gooutid" value="${editgoout.gooutid }" type="hidden">
