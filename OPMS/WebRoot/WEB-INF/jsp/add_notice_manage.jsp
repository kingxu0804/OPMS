...
<section>
    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right"><a href="#" class="btn btn-success">+添加新公告</a></div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form action="addNotice" class="form-horizontal adminex-form" id="notice-form" novalidate="novalidate">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>标题</label>
                                    <input name="noticeid" value="${noticeid }" type="hidden">
                                    <div class="col-sm-10">
                                        <input id="noticetitle" name="title" value="" class="form-control" placeholder="请填写名称" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
