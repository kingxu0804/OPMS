  ...
  <div class="left-side sticky-left-side" style="overflow: hidden;" tabindex="5000">
    ...
    <div class="main-content">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right"><a href="#" class="btn btn-success">+添加新部门</a></div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form  class="form-horizontal adminex-form" action="addDepartment" id="depart-form" novalidate="novalidate">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>名称</label>
                                    <input type="hidden" name="departid" value="${departid }">
                                    <div class="col-sm-10">
                                        <input id="checkname" name="name" value="" class="form-control" placeholder="请填写名称" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
