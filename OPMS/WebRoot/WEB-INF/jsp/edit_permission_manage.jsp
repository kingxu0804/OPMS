                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" method="post" action="updatePermission" id="permission-form" novalidate="novalidate">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">栏目</label>
                                    <div class="col-sm-10">
                                        <select name="parentid" class="form-control">
                                            <option value="${pmsPermissions.parentid}">${pmsPermissions.parentName}</option>
                                            <c:forEach items="${listPermissionParent }" var="permission">
                                            <c:if test="${pmsPermissions.parentid!=permission.permissionid}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="name" value="${pmsPermissions.name}" 
                                        class="form-control" placeholder="请输入名称，如项目管理" type="text">
                                        
                                        
                                        <input name="permissionid" value="${pmsPermissions.permissionid}" 
                                        type="hidden">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    	<c:if test="${pmsPermissions.type==0}">
                                    		<label class="radio-inline">
                                            <input name="type" value="0" type="radio" checked="checked">
                                            否 </label>
                                        <label class="radio-inline">
                                            <input name="type" value="1"  type="radio">
                                            是 </label>
                                    	</c:if>
                                    	<c:if test="${pmsPermissions.type==1}">
                                    		<label class="radio-inline">
                                            <input name="type" value="0" type="radio" >
                                            否 </label>
                                        <label class="radio-inline">
                                            <input name="type" value="1"  type="radio" checked="checked">
                                            是 </label>
                                    	</c:if>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="icon" value="${pmsPermissions.icon}" class="form-control" placeholder="主栏目ICON：user、tasks、suitcase、plane、laptop、home、book" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">排序</label>
                                    <div class="col-sm-10">
                                        <input name="weight" value="${pmsPermissions.weight}" class="form-control" placeholder="数字" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 col-sm-2 control-label"></label>
                                    <div class="col-lg-10">
                                        <!-- <input name="id" id="permissionid" value="41965474417741824" type="hidden"> -->
