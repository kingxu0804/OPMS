...
<section>
    ...
    <div class="main-content">
        <div class="header-section">
            ...
            <form class="searchform" action="searchPositionform" method="post">
        ...
        <div class="page-heading">
            ...
            <div class="pull-right"><a href="addPositionManage" class="btn btn-success">+添加新职称</a></div>
        </div>
        <div class="wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading"> 职称管理 / 总数：${counter }<span class="tools pull-right"><a href="javascript:;" class="fa fa-chevron-down"></a>
              </span> </header>
                            ...
                            <section id="unseen">
								...
								<c:forEach items="${listPmsPositions}" var="position">
                                        ...
                                        <tr>
                                            ...
                                            <c:if test="${position.status==1}">正常 </c:if>
                                            <c:if test="${position.status==2}">屏蔽 </c:if>
                                            </td>
                                            <td><div class="btn-group">
                                                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 操作<span class="caret"></span> </button>
                                                <ul class="dropdown-menu">
                                                    <li><a href="getPositionManageById?positionid=${position.positionid}">编辑</a></li>
                                                    <li role="separator" class="divider"></li>

                                                   
                                                      <li><a  class="js-position-single" data-id="${position.positionid}"
                                                       data-status="${position.status==1?2:1}"  id="status">
                                                      	<c:if test="${position.status==1}">屏蔽</c:if>
                                                    	
                                                    	<c:if test="${position.status==2}">正常</c:if>
