                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="updateOvertimeInfo" method="post" class="form-horizontal adminex-form" id="overtime-form" novalidate="novalidate">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-large custom-date-range" data-date="2016-07-07" data-date-format="yyyy-mm-dd">
                                            <input id="datetimeStart"  class="form-control dpd1" name="started" placeholder="开始日期" value="${oneOvertime.started }" type="text">
                                            <span class="input-group-addon">To</span>
                                            <input id="datetimeEnd" class="form-control dpd2" name="ended" placeholder="结束日期" value="${oneOvertime.ended }" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="longtime" value="${oneOvertime.longtime }" class="form-control" placeholder="请输入数字" type="number">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>核算方式</label>
                                    <div class="col-sm-10">
                                        <select name="way" class="form-control" id="selectWay">
                                            <option value="">请选择核算</option>
                                            <option value="1" selected="">调休</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="holiday" class="form-control" id="selectholiday">
                                            <option value="">请选择核算</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="reason" placeholder="加班事由" style="height: 200px;" class="form-control">${oneOvertime.reason }</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="approverids" id="approverid" value="${oneOvertime.approverids }" type="hidden">
                                        <input name="userid"  value="${user.userid }" type="hidden">
                                        <input name="overtimeid" id="overtimeid" value="${oneOvertime.overtimeid }" type="hidden">
                                        <button type="submit" class="btn btn-primary">提交保存</button>${updateOvertimemassage}
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script>
    $(function(){
    	...
    	$('#selectWay').val(${oneOvertime.way});
      
        $('#selectholiday').val(${oneOvertime.holiday });
