                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal adminex-form" id="needs-form" novalidate="novalidate" method="post" action="insertNeed" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>需求名称</label>
                                    <div class="col-sm-10">
                                        <input name="name" value="" id="need_name" class="form-control" placeholder="请输入需求名称" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
