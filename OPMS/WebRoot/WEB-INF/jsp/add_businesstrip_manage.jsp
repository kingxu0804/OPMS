                            ...
                            <form class="form-horizontal adminex-form" id="businesstrip-form" novalidate="novalidate">
                                ...
                                <div class="js-businesstripBox">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="destinations" class="form-control" placeholder="请输入目的地" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-large custom-date-range" data-date="2016-07-07" data-date-format="yyyy-mm-dd">
                                                <input id="datetimeStart" class="form-control dpd1" name="starteds" placeholder="开始日期" type="text">
                                                <span class="input-group-addon">To</span>
                                                <input id="datetimeEnd" class="form-control dpd2" name="endeds" placeholder="结束日期" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="days" id="days"  class="form-control" placeholder="请输入数字" type="number">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>出差事由</label>
                                    <div class="col-sm-10">
                                        <textarea name="reason" id="reason" placeholder="请输入出差事由" style="height: 200px;" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
...
<!--                                         <input name="id" id="businesstripid" value="0" type="hidden"> -->
